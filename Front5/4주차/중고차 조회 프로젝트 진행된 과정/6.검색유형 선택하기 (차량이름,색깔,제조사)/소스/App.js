...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      renderCall:0,
      carList:[
        {id:1,car_name:'aaa',provider:'bbb',
        color:'ccc',produce_date:'ddd',receiving_date:'eee',
        price:'fff',accident:'ggg',displacement:'hhh',
        distance_driven:'iii',fuel:'jjj',transmission:'kkk'}
      ]
    }
  }
